...
of the unit and the pod reconnects — that is the whole re-provisioning story. To rotate a
key deliberately, delete the pod's line from the key table and re-run.
