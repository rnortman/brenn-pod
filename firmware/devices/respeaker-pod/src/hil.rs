...
use crate::{
    ...
    run_speaker_output, run_stream_realtime_duplex, run_tcp_inbound_backpressure,
    run_tcp_inbound_frames, run_tcp_roundtrip, run_tcp_send_backpressure, run_tls_reachability,
    run_udp_roundtrip, run_wifi_associate, run_wifi_power_save_check, run_wifi_reassociation,
    run_wifi_scan, run_xvf3800_doa_plausibility, run_xvf3800_reg_read, run_xvf3800_sp_energy,
};
...
pub(crate) fn run_handler(name: TestName) -> (Status, Payload) {
    match name {
        ...
        TestName::TcpRoundtrip => run_tcp_roundtrip(),
        ...
        TestName::TcpInboundFrames => run_tcp_inbound_frames(),
        TestName::TcpSendBackpressure => run_tcp_send_backpressure(),
